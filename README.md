...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/idds-doma-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13462&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/idds-doma-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `idds-doma` can be installed with:

```
conda install idds-doma
```

It is possible to list all of the versions of `idds-doma` available on your platform with:
